...
@TeleoperatorConfig.register_subclass("onero_a1_leader")
@dataclass
class OneroA1LeaderConfig(TeleoperatorConfig):
    ...
    zero_force_kp: float = 5.0  # Proportional gain for MIT control
    zero_force_kd: float = 0.5  # Derivative gain for MIT control
